...
iOSController.getScreenshotLibimobiledevice = function (customScreenshotFolder, cb) {
    var cmd = exec('idevicescreenshot', ['-u udid file.tiff'], { cwd: '/libimobiledevice/bin/path' });
